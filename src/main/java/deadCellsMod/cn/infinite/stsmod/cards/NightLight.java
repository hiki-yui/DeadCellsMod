...
public class NightLight extends DeadCellsCard{
    ...
    public NightLight(){
        super(BASE_ID,STRINGS.NAME,"img/card/NightLight.png",1,STRINGS.DESCRIPTION,CardType.POWER, AbstractDeadCellsEnum.DEAD_CELLS,CardRarity.UNCOMMON,CardTarget.SELF);
        this.setBackgroundTexture(DeadCellsModInitializer.GRAY_POWER_CARD, DeadCellsModInitializer.GRAY_POWER_CARD_PORTRAIT);
